...
public class SimpleFrameworkDeAndSerializer{
     ...
     *
     * @throws UserMsgException Signals that an usage error has occurred through the user. NOTE: There will automatically be displayed a message box to the user. Thus, this
     *                          exception should just be caught but no further actions to handle it should be necessary. NOTE: The function Errorhandler#logException will ignore
     *                          this exception and not perform a logging.
     */
    public static <T extends Object> T deserialize(Class<T> classTarget,
        ...
        try{
            ...
            return serializer.read(classTarget, source);
        }catch(Exception ex){
